...
public class company extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5587905877322470711L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"company\",\"namespace\":\"com.learning.domain\",\"fields\":[{\"name\":\"companyName\",\"type\":\"string\"},{\"name\":\"year\",\"type\":\"int\"}]}");
   ...
   */
  public static com.learning.domain.company.Builder newBuilder() {
    return new com.learning.domain.company.Builder();
  }
   ...
   * @return A new company RecordBuilder
   */
  public static com.learning.domain.company.Builder newBuilder(com.learning.domain.company.Builder other) {
    return new com.learning.domain.company.Builder(other);
  }
   ...
   * @return A new company RecordBuilder
   */
  public static com.learning.domain.company.Builder newBuilder(com.learning.domain.company other) {
    return new com.learning.domain.company.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<company>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.learning.domain.company.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.learning.domain.company other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.companyName)) {
        this.companyName = data().deepCopy(fields()[0].schema(), other.companyName);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.domain.company.Builder setCompanyName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.domain.company.Builder clearCompanyName() {
      companyName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.domain.company.Builder setYear(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.domain.company.Builder clearYear() {
