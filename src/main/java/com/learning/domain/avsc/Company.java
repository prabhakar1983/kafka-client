 ...
 */
package com.learning.domain.avsc;
...
public class Company extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5374213632784839547L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Company\",\"namespace\":\"com.learning.domain.avsc\",\"fields\":[{\"name\":\"companyName\",\"type\":\"string\"},{\"name\":\"year\",\"type\":\"int\"}]}");
   ...
   */
  public static com.learning.domain.avsc.Company.Builder newBuilder() {
    return new com.learning.domain.avsc.Company.Builder();
  }
   ...
   * @return A new Company RecordBuilder
   */
  public static com.learning.domain.avsc.Company.Builder newBuilder(com.learning.domain.avsc.Company.Builder other) {
    return new com.learning.domain.avsc.Company.Builder(other);
  }
   ...
   * @return A new Company RecordBuilder
   */
  public static com.learning.domain.avsc.Company.Builder newBuilder(com.learning.domain.avsc.Company other) {
    return new com.learning.domain.avsc.Company.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Company>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.learning.domain.avsc.Company.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.learning.domain.avsc.Company other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.companyName)) {
        this.companyName = data().deepCopy(fields()[0].schema(), other.companyName);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.domain.avsc.Company.Builder setCompanyName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.domain.avsc.Company.Builder clearCompanyName() {
      companyName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.domain.avsc.Company.Builder setYear(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.domain.avsc.Company.Builder clearYear() {
